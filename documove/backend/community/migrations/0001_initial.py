    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('themes', models.ManyToManyField(related_name='giving_themes', to='movies.Giving')),
                ('users', models.ManyToManyField(related_name='giving_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movies', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='point_movies', to='movies.movie')),
                ('users', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='point_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='donation',
